...
class TestQueryRouter:
    ...
    def test_recommendation_query_detection(self):
        ...
        for query in recommendation_queries:
            ...
            assert query_type == QueryType.RECOMMENDATION, f"Failed to detect recommendation query: {query}"
            assert confidence > 0.5
    
    def test_styling_advice_treated_as_recommendation(self):
        """Test that general styling advice queries are treated as recommendation requests"""
        styling_queries = [
